...
func (c *commandClient) ExecuteCommand(ctx context.Context, in *ExecuteCommandRequest, opts ...grpc.CallOption) (*ExecuteCommandReply, error) {
	out := new(ExecuteCommandReply)
	err := c.cc.Invoke(ctx, "/command.Command/ExecuteCommand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommandServer) ExecuteCommand(context.Context, *ExecuteCommandRequest) (*ExecuteCommandReply, error) {
...
func _Command_ExecuteCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecuteCommandRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommandServer).ExecuteCommand(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/command.Command/ExecuteCommand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommandServer).ExecuteCommand(ctx, req.(*ExecuteCommandRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Command_ExecuteCommand_Handler,
		},
	},
